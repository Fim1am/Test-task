...
[CustomEditor(typeof(DimensionData))]
public class DimensionDataEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            EditorUtility.DisplayDialog("Active cells count", "Active cells count: " + (target as DimensionData).GetCountActiveCells(), "OK");
        }
